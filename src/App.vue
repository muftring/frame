    ...
    <main class="content">
      ...
      <div class="module-area">
        <Transition name="module" mode="out-in">
          ...
          <PublishModule v-else-if="currentModule === 'publish'" key="publish" ref="publish" :initial-source="moduleData" @navigate="handleNavigate" />
...
export default {
  ...
  methods: {
    ...
    handleStageUpload(fileIds) {
      this.showSessionComplete = false
      this.moduleData = { type: 'stage-upload', fileIds }
      this.currentModule = 'publish'
    },
    handleNewSession() {
      this.showSessionComplete = false
